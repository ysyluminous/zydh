...
<body class="mobile ">
	<div class="header clearfix ">
		...
		<div class="logo-bg">
			...
			<ul class="top-menu">
				<li><a href="${pageContext.request.contextPath }/one/index.jsp"><i class="fa fa-home fa-fw"></i><span>首页</span></a></li>
				<li class="active"><a
					href="#nogo" tppabs=""><i
						class="fa fa-building-o"></i><span>建筑/室内</span></a></li>
				<!-- <li><a href="../book.html"
					><i
			...
			<div class="side-content">
				<ul class="left-nav">
					...
					<li class="no-child" id="icon"><a href="#top-links"><i
						...
						<ul>
							<li><a
								href="javascript:if(confirm('http://huaban.com/search/?q=%E5%BB%BA%E7%AD%91  \n\n���ļ��޷��� Teleport Ultra ����, ��Ϊ ����һ�����·���ⲿ������Ϊ�����ʼ��ַ�ĵ�ַ��  \n\n�����ڷ������ϴ���?'))window.location='http://huaban.com/search/?q=%E5%BB%BA%E7%AD%91'"
								onclick="return false;" class="fame-bg"><i
									class="fa fa-angle-right"></i>花瓣建筑</a></li>
						</ul></li>
					<li class="no-child" id="icon"><a href="#ling-gan-zi-xun"><i
							class="fa fa-coffee"></i>灵感 / 杂志</a><i class="open fa fa-plus"></i></li>
					<li class="no-child" id="icon"><a href="#yi-shu-jia-ling-gan""><i
							class="fa fa-lightbulb-o"
							style="font-size: 16px; margin: 0 6px 0 6px"></i>艺术界灵感</a><i
						class="open fa fa-plus"></i></li>
					<li class="no-child" id="icon"><a href="#bbs"><i
							class="fa fa-comments"></i>BBS</a><i class="open fa fa-plus"></i></li>
					<li class="no-child" id="icon"><a href="#mo-xing-tie-tu"><i
							class="fa fa-puzzle-piece"></i>模型 / 贴图</a><i class="open fa fa-plus"></i></li>
					<li class="no-child" id="icon"><a href="#tu-zhi-gui-fan"><i
							class="fa fa-file-text-o"></i>图纸 / 规范</a><i class="open fa fa-plus"></i></li>
					<li class="no-child" id="icon"><a href="#bim"><i
							class="fa fa-flask"></i>BIM</a><i class="open fa fa-plus"></i></li>
					<li class="no-child" id="icon"><a href="#tuan-dui-gong-jiu"><i
							class="fa fa-bolt" style="margin: 0 5px 0 7px;"></i>团队工具</a><i
						class="open fa fa-plus"></i></li>
					<li class="no-child" id="icon"><a href="#shi-nei-she-ji"><i
							class="fa fa-bug"></i>室内设计</a><i class="open fa fa-plus"></i></li>
					<li class="no-child" id="icon"><a href="#jing-guan-she-ji"><i
							class="fa fa-bug"></i>景观设计</a><i class="open fa fa-plus"></i></li>
					<li class="no-child" id="icon"><a href="#she-ji-jiao-cheng"><i
							class="fa fa-bug"></i>设计教程</a><i class="open fa fa-plus"></i></li>
					<li class="no-child" id="icon"><a href="#school"><i
							class="fa fa-bug"></i>教学培训</a><i class="open fa fa-plus"></i></li>
				</ul>
			</div>
		</div>
		<!-- /.left-side-->
			...
			<div class="">
				...
				<div class="box-main">
					...
					<div class="bd-share">
						...
						<div class="slogan">
							<ul>
								<li><span>o(*≧▽≦)ツ･ﾟ✧ </span> 建筑导航 BETA 2017 低调上线！ <span>
										*:･ﾟ✧ヽ(◕‿◕ヽ)</span></li>
								<li>↑ 设计书籍频道已开放，感谢分享的小伙伴们 ↑</li>
							</ul>
						</div>
					</div>
					<!-- ./ baidu share -->
					...
					<div class="box-links">
							...
							<div class="panel-body">
								<dl class="row">
									<dd class="col-sm-3 col-md-2 col-xs-4">
										<a
											href="javascript:if(confirm('http://www.archdaily.com/  \n\n���ļ��޷��� Teleport Ultra ����, ��Ϊ ����һ�����·���ⲿ������Ϊ�����ʼ��ַ�ĵ�ַ��  \n\n�����ڷ������ϴ���?'))window.location='http://www.archdaily.com/'"
											target="_blank"><i class="link-logo"></i><span
											class="link-title">ArchDaily</span></a><span class="sub-link"><span
											class="link-info">全世界建筑师必看网站</span><a
											href="javascript:if(confirm('http://www.archdaily.cn/cn  \n\n���ļ��޷��� Teleport Ultra ����, ��Ϊ ����һ�����·���ⲿ������Ϊ�����ʼ��ַ�ĵ�ַ��  \n\n�����ڷ������ϴ���?'))window.location='http://www.archdaily.cn/cn'"
											target="_blank">中文站</a></span>
									</dd>
									<dd class="col-sm-3 col-md-2 col-xs-4">
										<a
											href="javascript:if(confirm('https://www.dezeen.com/  \n\n���ļ��޷��� Teleport Ultra ����, ��Ϊ ����һ�����·���ⲿ������Ϊ�����ʼ��ַ�ĵ�ַ��  \n\n�����ڷ������ϴ���?'))window.location='https://www.dezeen.com/'"
											target="_blank"><i class="link-logo"></i><span
											class="link-title">Dezeen</span><span class="link-info">建筑界权威媒体，增评选为生活不能缺少的50大网站</span></a>
									</dd>
									<dd class="col-sm-3 col-md-2 col-xs-4">
										<a
											href="javascript:if(confirm('http://www.architecturaldigest.com/  \n\n���ļ��޷��� Teleport Ultra ����, ��Ϊ ����һ�����·���ⲿ������Ϊ�����ʼ��ַ�ĵ�ַ��  \n\n�����ڷ������ϴ���?'))window.location='http://www.architecturaldigest.com/'"
											target="_blank"><i class="link-logo"></i><span
											class="link-title">architecturaldigest</span></a><span
											class="sub-link"><span class="link-info">建筑/室内/生活的高质感月刊</span><a
											href="javascript:if(confirm('http://www.adstyle.com.cn/  \n\n���ļ��޷��� Teleport Ultra ����, ��Ϊ ����һ�����·���ⲿ������Ϊ�����ʼ��ַ�ĵ�ַ��  \n\n�����ڷ������ϴ���?'))window.location='http://www.adstyle.com.cn/'"
											target="_blank">中文站</a></span>
									</dd>
									<dd class="col-sm-3 col-md-2 col-xs-4">
										<a
											href="javascript:if(confirm('https://architizer.com/  \n\n���ļ��޷��� Teleport Ultra ����, ��Ϊ ����һ�����·���ⲿ������Ϊ�����ʼ��ַ�ĵ�ַ��  \n\n�����ڷ������ϴ���?'))window.location='https://architizer.com/'"
											target="_blank"><i class="link-logo"></i><span
											class="link-title">Architizer</span><span class="link-info">建筑师可以上传作品并获得同行点评</span></a>
									</dd>
									<dd class="col-sm-3 col-md-2 col-xs-4">
										<a
											href="javascript:if(confirm('http://archinect.com/  \n\n���ļ��޷��� Teleport Ultra ����, ��Ϊ ����һ�����·���ⲿ������Ϊ�����ʼ��ַ�ĵ�ַ��  \n\n�����ڷ������ϴ���?'))window.location='http://archinect.com/'"
											target="_blank"><i class="link-logo"></i><span
											class="link-title">Archinect</span><span class="link-info">美国最大的建筑论坛，聚集全球设计师交流设计</span></a>
									</dd>
									<dd class="col-sm-3 col-md-2 col-xs-4">
										<a
											href="javascript:if(confirm('https://www.lifeofanarchitect.com/  \n\n���ļ��޷��� Teleport Ultra ����, ��Ϊ ����һ�����·���ⲿ������Ϊ�����ʼ��ַ�ĵ�ַ��  \n\n�����ڷ������ϴ���?'))window.location='https://www.lifeofanarchitect.com/'"
											target="_blank"><i class="link-logo"></i><span
											class="link-title">Life of an architect</span><span
											class="link-info">建筑师生活及建筑美学的博客(1更/周)</span></a>
									</dd>
									<dd class="col-sm-3 col-md-2 col-xs-4">
										<a
											href="javascript:if(confirm('http://www.rushiJava/  \n\n���ļ��޷��� Teleport Ultra ����, ��Ϊ ����һ�����·���ⲿ������Ϊ�����ʼ��ַ�ĵ�ַ��  \n\n�����ڷ������ϴ���?'))window.location='http://www.rushiJava/'"
											target="_blank"><i class="link-logo"></i><span
											class="link-title text-warning">如室网</span><span
											class="link-info">首发全球顶尖建筑室内作品，全球最大案例库</span></a>
									</dd>
									<dd class="col-sm-3 col-md-2 col-xs-4">
										<a
											href="javascript:if(confirm('http://www.gooood.hk/  \n\n���ļ��޷��� Teleport Ultra ����, ��Ϊ ����һ�����·���ⲿ������Ϊ�����ʼ��ַ�ĵ�ַ��  \n\n�����ڷ������ϴ���?'))window.location='http://www.gooood.hk/'"
											target="_blank"><i class="link-logo"></i><span
											class="link-title">谷德网</span><span class="link-info">建筑与景观设计平台</span></a>
									</dd>
									<dd class="col-sm-3 col-md-2 col-xs-4">
										<a
											href="javascript:if(confirm('http://www.abbs.com.cn/bbs/  \n\n���ļ��޷��� Teleport Ultra ����, ��Ϊ ����һ�����·���ⲿ������Ϊ�����ʼ��ַ�ĵ�ַ��  \n\n�����ڷ������ϴ���?'))window.location='http://www.abbs.com.cn/bbs/'"
											target="_blank"><i class="link-logo"></i><span
											class="link-title">ABBS建筑论坛</span><span class="link-info">建筑师们的论坛，舍都有</span></a>
									</dd>
									<dd class="col-sm-3 col-md-2 col-xs-4">
										<a
											href="javascript:if(confirm('http://www.archcollege.com/  \n\n���ļ��޷��� Teleport Ultra ����, ��Ϊ ����һ�����·���ⲿ������Ϊ�����ʼ��ַ�ĵ�ַ��  \n\n�����ڷ������ϴ���?'))window.location='http://www.archcollege.com/'"
											target="_blank"><i class="link-logo"></i><span
											class="link-title">建筑学院</span><span class="link-info">大量建筑设计案例、行业知识、经验见解</span></a>
									</dd>
									<dd class="col-sm-3 col-md-2 col-xs-4">
										<a
											href="javascript:if(confirm('http://www.iarch.cn/  \n\n���ļ��޷��� Teleport Ultra ����, ��Ϊ ����һ�����·���ⲿ������Ϊ�����ʼ��ַ�ĵ�ַ��  \n\n�����ڷ������ϴ���?'))window.location='http://www.iarch.cn/'"
											target="_blank"><i class="link-logo"></i><span
											class="link-title">专筑</span><span class="link-info">建筑规划景观园林室内等专业</span></a>
									</dd>
									<dd class="col-sm-3 col-md-2 col-xs-4 zcool">
										<a
											href="javascript:if(confirm('https://www.pinterest.com/search/pins/?q=architecture  \n\n���ļ��޷��� Teleport Ultra ����, ��Ϊ ����һ�����·���ⲿ������Ϊ�����ʼ��ַ�ĵ�ַ��  \n\n�����ڷ������ϴ���?'))window.location='https://www.pinterest.com/search/pins/?q=architecture'"
											target="_blank"><i class="link-logo"></i><span
											class="link-title">Pinterest 建筑</span></a><span class="sub-link"><span
											class="link-info">全世界建筑灵感都在这了</span><a
											href="javascript:if(confirm('http://huaban.com/search/?q=%E5%BB%BA%E7%AD%91  \n\n���ļ��޷��� Teleport Ultra ����, ��Ϊ ����һ�����·���ⲿ������Ϊ�����ʼ��ַ�ĵ�ַ��  \n\n�����ڷ������ϴ���?'))window.location='http://huaban.com/search/?q=%E5%BB%BA%E7%AD%91'"
											target="_blank">花瓣建筑</a></span>
									</dd>
								</dl>
							</div>
						</div>
						...
						<div class="links panel">
							<div class="panel-heading">
								<i class="fa fa-coffee"></i>灵感/杂志
							</div>
							<div class="panel-body">
								<dl class="row">
									<dd class="col-sm-3 col-md-2 col-xs-4">
										<a
											href="javascript:if(confirm('https://divisare.com/  \n\n���ļ��޷��� Teleport Ultra ����, ��Ϊ ����һ�����·���ⲿ������Ϊ�����ʼ��ַ�ĵ�ַ��  \n\n�����ڷ������ϴ���?'))window.location='https://divisare.com/'"
											target="_blank"><i class="link-logo"></i><span
											class="link-title">Divisare</span><span class="link-info">意大利建筑杂志，很多优秀建筑灵感</span></a>
									</dd>
									<dd class="col-sm-3 col-md-2 col-xs-4">
										<a
											href="javascript:if(confirm('https://archpaper.com/  \n\n���ļ��޷��� Teleport Ultra ����, ��Ϊ ����һ�����·���ⲿ������Ϊ�����ʼ��ַ�ĵ�ַ��  \n\n�����ڷ������ϴ���?'))window.location='https://archpaper.com/'"
											target="_blank"><i class="link-logo"></i><span
											class="link-title">archpaper</span><span class="link-info">美国权威建筑与设计杂志</span></a>
									</dd>
									<dd class="col-sm-3 col-md-2 col-xs-4">
										<a
											href="javascript:if(confirm('http://bustlerJava/  \n\n���ļ��޷��� Teleport Ultra ����, ��Ϊ ����һ�����·���ⲿ������Ϊ�����ʼ��ַ�ĵ�ַ��  \n\n�����ڷ������ϴ���?'))window.location='http://bustlerJava/'"
											target="_blank"><i class="link-logo"></i><span
											class="link-title">Bustler</span><span class="link-info">由Archinect创建的建筑资讯网站</span></a>
									</dd>
									<dd class="col-sm-3 col-md-2 col-xs-4">
										<a
											href="javascript:if(confirm('https://www.architectsjournal.co.uk/  \n\n���ļ��޷��� Teleport Ultra ����, ��Ϊ ����һ�����·���ⲿ������Ϊ�����ʼ��ַ�ĵ�ַ��  \n\n�����ڷ������ϴ���?'))window.location='https://www.architectsjournal.co.uk/'"
											target="_blank"><i class="link-logo"></i><span
											class="link-title">Architects journal</span><span
											class="link-info">英国建筑杂志网站</span></a>
									</dd>
									<dd class="col-sm-3 col-md-2 col-xs-4">
										<a
											href="javascript:if(confirm('http://www.architecturalrecord.com/  \n\n���ļ��޷��� Teleport Ultra ����, ��Ϊ ����һ�����·���ⲿ������Ϊ�����ʼ��ַ�ĵ�ַ��  \n\n�����ڷ������ϴ���?'))window.location='http://www.architecturalrecord.com/'"
											target="_blank"><i class="link-logo"></i><span
											class="link-title">Architectural Record</span><span
											class="link-info">美国著名建筑/室内设计杂志</span></a>
									</dd>
									<dd class="col-sm-3 col-md-2 col-xs-4">
										<a
											href="javascript:if(confirm('http://archidose.blogspot.hk/  \n\n���ļ��޷��� Teleport Ultra ����, ��Ϊ ����һ�����·���ⲿ������Ϊ�����ʼ��ַ�ĵ�ַ��  \n\n�����ڷ������ϴ���?'))window.location='http://archidose.blogspot.hk/'"
											target="_blank"><i class="link-logo"></i><span
											class="link-title">Archidose</span><span class="link-info">纽约市的每日建筑艺术和图像(VPN)</span></a>
									</dd>
									<dd class="col-sm-3 col-md-2 col-xs-4">
										<a
											href="javascript:if(confirm('http://www.architektourist.de/  \n\n���ļ��޷��� Teleport Ultra ����, ��Ϊ ����һ�����·���ⲿ������Ϊ�����ʼ��ַ�ĵ�ַ��  \n\n�����ڷ������ϴ���?'))window.location='http://www.architektourist.de/'"
											target="_blank"><i class="link-logo"></i><span
											class="link-title">Architektourist</span><span
											class="link-info">德国的一个建筑灵感网站</span></a>
									</dd>
									<dd class="col-sm-3 col-md-2 col-xs-4">
										<a
											href="javascript:if(confirm('http://architecturephotoJava/  \n\n���ļ��޷��� Teleport Ultra ����, ��Ϊ ����һ�����·���ⲿ������Ϊ�����ʼ��ַ�ĵ�ַ��  \n\n�����ڷ������ϴ���?'))window.location='http://architecturephotoJava/'"
											target="_blank"><i class="link-logo"></i><span
											class="link-title">architecturephoto</span><span
											class="link-info">日本的一个建筑媒体网站</span></a>
									</dd>
									<dd class="col-sm-3 col-md-2 col-xs-4">
										<a
											href="javascript:if(confirm('http://www.archaeology.org/  \n\n���ļ��޷��� Teleport Ultra ����, ��Ϊ ����һ�����·���ⲿ������Ϊ�����ʼ��ַ�ĵ�ַ��  \n\n�����ڷ������ϴ���?'))window.location='http://www.archaeology.org/'"
											target="_blank"><i class="link-logo"></i><span
											class="link-title">Archaeology</span><span class="link-info">美国考古学院杂志</span></a>
									</dd>
									<dd class="col-sm-3 col-md-2 col-xs-4">
										<a
											href="javascript:if(confirm('http://www.evolo.us/  \n\n���ļ��޷��� Teleport Ultra ����, ��Ϊ ����һ�����·���ⲿ������Ϊ�����ʼ��ַ�ĵ�ַ��  \n\n�����ڷ������ϴ���?'))window.location='http://www.evolo.us/'"
											target="_blank"><i class="link-logo"></i><span
											class="link-title">EVOLO</span><span class="link-info">分享创意建筑灵感(1更/周)</span></a>
									</dd>
									<dd class="col-sm-3 col-md-2 col-xs-4">
										<a
											href="javascript:if(confirm('http://www.domusweb.it/en/  \n\n���ļ��޷��� Teleport Ultra ����, ��Ϊ ����һ�����·���ⲿ������Ϊ�����ʼ��ַ�ĵ�ַ��  \n\n�����ڷ������ϴ���?'))window.location='http://www.domusweb.it/en/'"
											target="_blank"><i class="link-logo"></i><span
											class="link-title">Domusweb</span><span class="link-info">建筑、家具、设计艺术在线杂志</span></a>
									</dd>
									<dd class="col-sm-3 col-md-2 col-xs-4">
										<a
											href="javascript:if(confirm('http://www.contemporist.com/  \n\n���ļ��޷��� Teleport Ultra ����, ��Ϊ ����һ�����·���ⲿ������Ϊ�����ʼ��ַ�ĵ�ַ��  \n\n�����ڷ������ϴ���?'))window.location='http://www.contemporist.com/'"
											target="_blank"><i class="link-logo"></i><span
											class="link-title">contemporist</span><span class="link-info">专注于建筑、设计、艺术和旅游</span></a>
									</dd>
								</dl>
								<dl class="row">
									<dd class="col-sm-3 col-md-2 col-xs-4">
										<a
											href="javascript:if(confirm('http://www.archreport.com.cn/  \n\n���ļ��޷��� Teleport Ultra ����, ��Ϊ ����һ�����·���ⲿ������Ϊ�����ʼ��ַ�ĵ�ַ��  \n\n�����ڷ������ϴ���?'))window.location='http://www.archreport.com.cn/'"
											target="_blank"><i class="link-logo"></i><span
											class="link-title">中国建筑中心官网</span><span class="link-info">国际设计交易平台</span></a>
									</dd>
									<dd class="col-sm-3 col-md-2 col-xs-4">
										<a
											href="javascript:if(confirm('http://forgemindJava/media/  \n\n���ļ��޷��� Teleport Ultra ����, ��Ϊ ����һ�����·���ⲿ������Ϊ�����ʼ��ַ�ĵ�ַ��  \n\n�����ڷ������ϴ���?'))window.location='http://forgemindJava/media/'"
											target="_blank"><i class="link-logo"></i><span
											class="link-title">準建築人手札</span><span class="link-info">台湾准建筑人手札</span></a>
									</dd>
									<dd class="col-sm-3 col-md-2 col-xs-4">
										<a
											href="javascript:if(confirm('http://www.architbang.com/  \n\n���ļ��޷��� Teleport Ultra ����, ��Ϊ ����һ�����·���ⲿ������Ϊ�����ʼ��ַ�ĵ�ַ��  \n\n�����ڷ������ϴ���?'))window.location='http://www.architbang.com/'"
											target="_blank"><i class="link-logo"></i><span
											class="link-title">建筑邦</span><span class="link-info">专注于建筑设计的互动分享</span></a>
									</dd>
									<dd class="col-sm-3 col-md-2 col-xs-4">
										<a
											href="javascript:if(confirm('http://www.lvshedesign.com/  \n\n���ļ��޷��� Teleport Ultra ����, ��Ϊ ����һ�����·���ⲿ������Ϊ�����ʼ��ַ�ĵ�ַ��  \n\n�����ڷ������ϴ���?'))window.location='http://www.lvshedesign.com/'"
											target="_blank"><i class="link-logo"></i><span
											class="link-title">旅设</span><span class="link-info">分享建筑设计灵感</span></a>
									</dd>
									<dd class="col-sm-3 col-md-2 col-xs-4">
										<a
											href="javascript:if(confirm('http://www.ideamass.com.cn/  \n\n���ļ��޷��� Teleport Ultra ����, ��Ϊ ����һ�����·���ⲿ������Ϊ�����ʼ��ַ�ĵ�ַ��  \n\n�����ڷ������ϴ���?'))window.location='http://www.ideamass.com.cn/'"
											target="_blank"><i class="link-logo"></i><span
											class="link-title">灵感集</span><span class="link-info">分享建筑设计灵感</span></a>
									</dd>
									<dd class="col-sm-3 col-md-2 col-xs-4">
										<a
											href="javascript:if(confirm('http://www.ibanana.me/  \n\n���ļ��޷��� Teleport Ultra ����, ��Ϊ ����һ�����·���ⲿ������Ϊ�����ʼ��ַ�ĵ�ַ��  \n\n�����ڷ������ϴ���?'))window.location='http://www.ibanana.me/'"
											target="_blank"><i class="link-logo"></i><span
											class="link-title">香蕉网</span><span class="link-info">分享建筑设计灵感</span></a>
									</dd>
								</dl>
							</div>
						</div>
						<hr id="yi-shu-jia-ling-gan" />
						<div class="links panel">
							<div class="panel-heading">
								<i class="fa fa-lightbulb-o"></i>艺术界灵感
							</div>
							<div class="panel-body">
								<dl class="row">
									<dd class="col-sm-3 col-md-2 col-xs-4">
										<a
											href="javascript:if(confirm('http://www.thisiscolossal.com/  \n\n���ļ��޷��� Teleport Ultra ����, ��Ϊ ����һ�����·���ⲿ������Ϊ�����ʼ��ַ�ĵ�ַ��  \n\n�����ڷ������ϴ���?'))window.location='http://www.thisiscolossal.com/'"
											target="_blank"><i class="link-logo"></i><span
											class="link-title">Colossal</span><span class="link-info">优秀的艺术、设计灵感网站</span></a>
									</dd>
									<dd class="col-sm-3 col-md-2 col-xs-4">
										<a
											href="javascript:if(confirm('http://www.laboiteverte.fr/  \n\n���ļ��޷��� Teleport Ultra ����, ��Ϊ ����һ�����·���ⲿ������Ϊ�����ʼ��ַ�ĵ�ַ��  \n\n�����ڷ������ϴ���?'))window.location='http://www.laboiteverte.fr/'"
											target="_blank"><i class="link-logo"></i><span
											class="link-title">La boite verte</span><span
											class="link-info">全是创意作品，无聊就翻一翻</span></a>
									</dd>
									<dd class="col-sm-3 col-md-2 col-xs-4">
										<a
											href="javascript:if(confirm('https://www.busyboo.com/  \n\n���ļ��޷��� Teleport Ultra ����, ��Ϊ ����һ�����·���ⲿ������Ϊ�����ʼ��ַ�ĵ�ַ��  \n\n�����ڷ������ϴ���?'))window.location='https://www.busyboo.com/'"
											target="_blank"><i class="link-logo"></i><span
											class="link-title">busyboo</span><span class="link-info">让你发现建筑的简约之美</span></a>
									</dd>
									<dd class="col-sm-3 col-md-2 col-xs-4">
										<a
											href="javascript:if(confirm('https://www.designboom.com/  \n\n���ļ��޷��� Teleport Ultra ����, ��Ϊ ����һ�����·���ⲿ������Ϊ�����ʼ��ַ�ĵ�ַ��  \n\n�����ڷ������ϴ���?'))window.location='https://www.designboom.com/'"
											target="_blank"><i class="link-logo"></i><span
											class="link-title">Designboom</span><span class="link-info">综合设计灵感网站</span></a>
									</dd>
									<dd class="col-sm-3 col-md-2 col-xs-4">
										<a
											href="javascript:if(confirm('https://www.wallpaper.com/architecture  \n\n���ļ��޷��� Teleport Ultra ����, ��Ϊ ����һ�����·���ⲿ������Ϊ�����ʼ��ַ�ĵ�ַ��  \n\n�����ڷ������ϴ���?'))window.location='https://www.wallpaper.com/architecture'"
											target="_blank"><i class="link-logo"></i><span
											class="link-title">Wallpapaer*</span><span class="link-info">美到能做电脑壁纸建筑作品</span></a>
									</dd>
									<dd class="col-sm-3 col-md-2 col-xs-4">
										<a
											href="javascript:if(confirm('http://architectureblog.tumblr.com/  \n\n���ļ��޷��� Teleport Ultra ����, ��Ϊ ����һ�����·���ⲿ������Ϊ�����ʼ��ַ�ĵ�ַ��  \n\n�����ڷ������ϴ���?'))window.location='http://architectureblog.tumblr.com/'"
											target="_blank"><i class="link-logo"></i><span
											class="link-title">archTumblr</span><span class="link-info">Tumblr上的建筑内容相当丰富(VPN)</span></a>
									</dd>
								</dl>
							</div>
						</div>
						...
						<div class="links panel">
							<div class="panel-heading">
								<i class="fa fa-comments"></i>BBS
							</div>
							<div class="panel-body">
								<dl class="row">
									<dd class="col-sm-3 col-md-2 col-xs-4">
										<a
											href="javascript:if(confirm('http://bbs.zhulong.com/  \n\n���ļ��޷��� Teleport Ultra ����, ��Ϊ ����һ�����·���ⲿ������Ϊ�����ʼ��ַ�ĵ�ַ��  \n\n�����ڷ������ϴ���?'))window.location='http://bbs.zhulong.com/'"
											target="_blank"><i class="link-logo"></i><span
											class="link-title">筑龙论坛</span><span class="link-info">建筑行业互动平台</span></a>
									</dd>
									<dd class="col-sm-3 col-md-2 col-xs-4">
										<a
											href="javascript:if(confirm('http://www.eeeetop.com/  \n\n���ļ��޷��� Teleport Ultra ����, ��Ϊ ����һ�����·���ⲿ������Ϊ�����ʼ��ַ�ĵ�ַ��  \n\n�����ڷ������ϴ���?'))window.location='http://www.eeeetop.com/'"
											target="_blank"><i class="link-logo"></i><span
											class="link-title">E 拓网</span><span class="link-info">建筑学习与交流论坛</span></a>
									</dd>
									<dd class="col-sm-3 col-md-2 col-xs-4">
										<a
											href="javascript:if(confirm('http://bbs.co188.com/  \n\n���ļ��޷��� Teleport Ultra ����, ��Ϊ ����һ�����·���ⲿ������Ϊ�����ʼ��ַ�ĵ�ַ��  \n\n�����ڷ������ϴ���?'))window.location='http://bbs.co188.com/'"
											target="_blank"><i class="link-logo"></i><span
											class="link-title">土木论坛</span><span class="link-info">土木工程论坛</span></a>
									</dd>
									<dd class="col-sm-3 col-md-2 col-xs-4">
										<a
											href="javascript:if(confirm('http://wd.tJava.com/  \n\n���ļ��޷��� Teleport Ultra ����, ��Ϊ ����һ�����·���ⲿ������Ϊ�����ʼ��ַ�ĵ�ַ��  \n\n�����ڷ������ϴ���?'))window.location='http://wd.tJava.com/'"
											target="_blank"><i class="link-logo"></i><span
											class="link-title">天工网</span><span class="link-info">建筑问答BBS</span></a>
									</dd>
									<dd class="col-sm-3 col-md-2 col-xs-4">
										<a
											href="javascript:if(confirm('http://bbs.ncf-china.com/forum.php  \n\n���ļ��޷��� Teleport Ultra ����, ��Ϊ ����һ�����·���ⲿ������Ϊ�����ʼ��ַ�ĵ�ַ��  \n\n�����ڷ������ϴ���?'))window.location='http://bbs.ncf-china.com/forum.php'"
											target="_blank"><i class="link-logo"></i><span
											class="link-title">NCF参数化联盟</span><span class="link-info">参数化建筑设计信息共享平台</span></a>
									</dd>
									<dd class="col-sm-3 col-md-2 col-xs-4">
										<a
											href="javascript:if(confirm('http://www.sketchupbar.com/  \n\n���ļ��޷��� Teleport Ultra ����, ��Ϊ ����һ�����·���ⲿ������Ϊ�����ʼ��ַ�ĵ�ַ��  \n\n�����ڷ������ϴ���?'))window.location='http://www.sketchupbar.com/'"
											target="_blank"><i class="link-logo"></i><span
											class="link-title">SketchUP吧</span><span class="link-info">Sketchup资源&交流论坛</span></a>
									</dd>
								</dl>
							</div>
						</div>
						<hr id="mo-xing-tie-tu" />
						<div class="links panel">
							<div class="panel-heading">
								<i class="fa fa-puzzle-piece"></i>模型 / 贴图
							</div>
							<div class="panel-body">
								<dl class="row">
									<dd class="col-sm-3 col-md-2 col-xs-4">
										<a
											href="https://3dwarehouse.sketchup.com/index.html"
											target="_blank"><i class="link-logo"></i><span
											class="link-title">3dwarehouse</span><span class="link-info">Sketchup
												3D 模型分享</span></a>
									</dd>
									<dd class="col-sm-3 col-md-2 col-xs-4">
										<a
											href="https://www.textures.com/"
											target="_blank"><i class="link-logo"></i><span
											class="link-title">textures</span><span class="link-info">3D
												材质纹理素材</span></a>
									</dd>
									<dd class="col-sm-3 col-md-2 col-xs-4">
										<a
											href="http://www.xiadele.com/a/mz3d/'"
											target="_blank"><i class="link-logo"></i><span
											class="link-title">下得乐</span><span class="link-info">模型
												/ 贴图/CAD/建筑书籍下载</span></a>
									</dd>
									<dd class="col-sm-3 col-md-2 col-xs-4">
										<a
											href="https://archive3dJava/"
											target="_blank"><i class="link-logo"></i><span
											class="link-title">Archive 3D</span><span class="link-info">免费
												3D 模型下载</span></a>
									</dd>
									<dd class="col-sm-3 col-md-2 col-xs-4">
										<a
											href="javascript:if(confirm('https://lostandtaken.com/  \n\n���ļ��޷��� Teleport Ultra ����, ��Ϊ ����һ�����·���ⲿ������Ϊ�����ʼ��ַ�ĵ�ַ��  \n\n�����ڷ������ϴ���?'))window.location='https://lostandtaken.com/'"
											target="_blank"><i class="link-logo"></i><span
											class="link-title">L+T</span><span class="link-info">材质分享博客</span></a>
									</dd>
									<dd class="col-sm-3 col-md-2 col-xs-4">
										<a
											href="javascript:if(confirm('http://www.moxingjia.com/  \n\n���ļ��޷��� Teleport Ultra ����, ��Ϊ ����һ�����·���ⲿ������Ϊ�����ʼ��ַ�ĵ�ַ��  \n\n�����ڷ������ϴ���?'))window.location='http://www.moxingjia.com/'"
											target="_blank"><i class="link-logo"></i><span
											class="link-title">模型家</span><span class="link-info">场景/家具/室内/工业/室外模型</span></a>
									</dd>
									<dd class="col-sm-3 col-md-2 col-xs-4">
										<a
											href="javascript:if(confirm('https://www.nbimer.com/materials/sketchup-models  \n\n���ļ��޷��� Teleport Ultra ����, ��Ϊ ����һ�����·���ⲿ������Ϊ�����ʼ��ַ�ĵ�ַ��  \n\n�����ڷ������ϴ���?'))window.location='https://www.nbimer.com/materials/sketchup-models'"
											target="_blank"><i class="link-logo"></i><span
											class="link-title">毕马汇</span><span class="link-info">毕马汇
												Sketchup 素材</span></a>
									</dd>
									<dd class="col-sm-3 col-md-2 col-xs-4">
										<a
											href="javascript:if(confirm('http://archgo.cn/  \n\n���ļ��޷��� Teleport Ultra ����, ��Ϊ ����һ�����·���ⲿ������Ϊ�����ʼ��ַ�ĵ�ַ��  \n\n�����ڷ������ϴ���?'))window.location='http://archgo.cn/'"
											target="_blank"><i class="link-logo"></i><span
											class="link-title">Archgo</span><span class="link-info">Sketchup
												模型下载</span></a>
									</dd>
									<dd class="col-sm-3 col-md-2 col-xs-4">
										<a
											href="javascript:if(confirm('http://3d.jzscJava/  \n\n���ļ��޷��� Teleport Ultra ����, ��Ϊ ����һ�����·���ⲿ������Ϊ�����ʼ��ַ�ĵ�ַ��  \n\n�����ڷ������ϴ���?'))window.location='http://3d.jzscJava/'"
											target="_blank"><i class="link-logo"></i><span
											class="link-title">典尚模型</span><span class="link-info">资源全面的模型下载站</span></a>
									</dd>
									<dd class="col-sm-3 col-md-2 col-xs-4">
										<a
											href="javascript:if(confirm('http://www.pgive.com/  \n\n���ļ��޷��� Teleport Ultra ����, ��Ϊ ����һ�����·���ⲿ������Ϊ�����ʼ��ַ�ĵ�ַ��  \n\n�����ڷ������ϴ���?'))window.location='http://www.pgive.com/'"
											target="_blank"><i class="link-logo"></i><span
											class="link-title">批给屋</span><span class="link-info">建筑景观室内资讯及资源分享</span></a>
									</dd>
									<dd class="col-sm-3 col-md-2 col-xs-4">
										<a
											href="javascript:if(confirm('http://www.huanyiba.cn/3dcaizhi/  \n\n���ļ��޷��� Teleport Ultra ����, ��Ϊ ����һ�����·���ⲿ������Ϊ�����ʼ��ַ�ĵ�ַ��  \n\n�����ڷ������ϴ���?'))window.location='http://www.huanyiba.cn/3dcaizhi/'"
											target="_blank"><i class="link-logo"></i><span
											class="link-title">环艺吧贴图</span><span class="link-info">贴图、材质分享</span></a>
									</dd>
									<dd class="col-sm-3 col-md-2 col-xs-4">
										<a
											href="javascript:if(confirm('http://www.texturepalace.com/  \n\n���ļ��޷��� Teleport Ultra ����, ��Ϊ ����һ�����·���ⲿ������Ϊ�����ʼ��ַ�ĵ�ַ��  \n\n�����ڷ������ϴ���?'))window.location='http://www.texturepalace.com/'"
											target="_blank"><i class="link-logo"></i><span
											class="link-title">texture palace</span><span
											class="link-info">国外材质分享站（更新快）</span></a>
									</dd>
								</dl>
							</div>
						</div>
						<hr id="tu-zhi-gui-fan" />
						<div class="links panel">
							<div class="panel-heading">
								<i class="fa fa-file-text-o"></i>图纸 / 规范&方案
							</div>
							<div class="panel-body">
								<dl class="row">
									<dd class="col-sm-3 col-md-2 col-xs-4">
										<a
											href="javascript:if(confirm('http://www.bzfxw.com/  \n\n���ļ��޷��� Teleport Ultra ����, ��Ϊ ����һ�����·���ⲿ������Ϊ�����ʼ��ַ�ĵ�ַ��  \n\n�����ڷ������ϴ���?'))window.location='http://www.bzfxw.com/'"
											target="_blank"><i class="link-logo"></i><span
											class="link-title">学兔兔</span><span class="link-info">工程技术学习资源</span></a>
									</dd>
									<dd class="col-sm-3 col-md-2 col-xs-4">
										<a
											href="javascript:if(confirm('http://www.soujianzhu.cn/  \n\n���ļ��޷��� Teleport Ultra ����, ��Ϊ ����һ�����·���ⲿ������Ϊ�����ʼ��ַ�ĵ�ַ��  \n\n�����ڷ������ϴ���?'))window.location='http://www.soujianzhu.cn/'"
											target="_blank"><i class="link-logo"></i><span
											class="link-title">搜建筑</span><span class="link-info">提供户型资料及建筑资讯</span></a>
									</dd>
									<dd class="col-sm-3 col-md-2 col-xs-4">
										<a
											href="javascript:if(confirm('http://info.tJava.com/  \n\n���ļ��޷��� Teleport Ultra ����, ��Ϊ ����һ�����·���ⲿ������Ϊ�����ʼ��ַ�ĵ�ַ��  \n\n�����ڷ������ϴ���?'))window.location='http://info.tJava.com/'"
											target="_blank"><i class="link-logo"></i><span
											class="link-title">天工网</span><span class="link-info">天工网资源分享区</span></a>
									</dd>
									<dd class="col-sm-3 col-md-2 col-xs-4">
										<a
											href="javascript:if(confirm('http://www.ddove.com/data/3.html  \n\n���ļ��޷��� Teleport Ultra ����, ��Ϊ ����һ�����·���ⲿ������Ϊ�����ʼ��ַ�ĵ�ַ��  \n\n�����ڷ������ϴ���?'))window.location='http://www.ddove.com/data/3.html'"
											target="_blank"><i class="link-logo"></i><span
											class="link-title">定鼎网</span><span class="link-info">定鼎网建筑资料库</span></a>
									</dd>
									<dd class="col-sm-3 col-md-2 col-xs-4">
										<a
											href="javascript:if(confirm('http://www.99jianzhu.com/Tuji/  \n\n���ļ��޷��� Teleport Ultra ����, ��Ϊ ����һ�����·���ⲿ������Ϊ�����ʼ��ַ�ĵ�ַ��  \n\n�����ڷ������ϴ���?'))window.location='http://www.99jianzhu.com/Tuji/'"
											target="_blank"><i class="link-logo"></i><span
											class="link-title">久久建筑</span><span class="link-info">建筑图集、CAD、考试资料等</span></a>
									</dd>
									<dd class="col-sm-3 col-md-2 col-xs-4">
										<a
											href="javascript:if(confirm('http://www.ixianji.com/  \n\n���ļ��޷��� Teleport Ultra ����, ��Ϊ ����һ�����·���ⲿ������Ϊ�����ʼ��ַ�ĵ�ַ��  \n\n�����ڷ������ϴ���?'))window.location='http://www.ixianji.com/'"
											target="_blank"><i class="link-logo"></i><span
											class="link-title">统计网</span><span class="link-info">提供建筑景观方案资料</span></a>
									</dd>
									<dd class="col-sm-3 col-md-2 col-xs-4">
										<a
											href="javascript:if(confirm('http://www.jzkooJava/  \n\n���ļ��޷��� Teleport Ultra ����, ��Ϊ ����һ�����·���ⲿ������Ϊ�����ʼ��ַ�ĵ�ַ��  \n\n�����ڷ������ϴ���?'))window.location='http://www.jzkooJava/'"
											target="_blank"><i class="link-logo"></i><span
											class="link-title">建筑酷</span><span class="link-info">综合建筑资源分享</span></a>
									</dd>
									<dd class="col-sm-3 col-md-2 col-xs-4">
										<a
											href="javascript:if(confirm('http://ziliao.co188.com/drawing/  \n\n���ļ��޷��� Teleport Ultra ����, ��Ϊ ����һ�����·���ⲿ������Ϊ�����ʼ��ַ�ĵ�ַ��  \n\n�����ڷ������ϴ���?'))window.location='http://ziliao.co188.com/drawing/'"
											target="_blank"><i class="link-logo"></i><span
											class="link-title">土木在线</span><span class="link-info">[图纸]土木在线资料馆</span></a>
									</dd>
									<dd class="col-sm-3 col-md-2 col-xs-4">
										<a
											href="javascript:if(confirm('http://www.tuzi8.com/  \n\n���ļ��޷��� Teleport Ultra ����, ��Ϊ ����һ�����·���ⲿ������Ϊ�����ʼ��ַ�ĵ�ַ��  \n\n�����ڷ������ϴ���?'))window.location='http://www.tuzi8.com/'"
											target="_blank"><i class="link-logo"></i><span
											class="link-title">别墅图库</span><span class="link-info">[图纸]农村房屋、别墅CAD图库</span></a>
									</dd>
									<dd class="col-sm-3 col-md-2 col-xs-4">
										<a
											href="javascript:if(confirm('http://down6.zhulong.com/  \n\n���ļ��޷��� Teleport Ultra ����, ��Ϊ ����һ�����·���ⲿ������Ϊ�����ʼ��ַ�ĵ�ַ��  \n\n�����ڷ������ϴ���?'))window.location='http://down6.zhulong.com/'"
											target="_blank"><i class="link-logo"></i><span
											class="link-title">筑龙资料馆</span><span class="link-info">[图纸]建筑工程资料分享平台</span></a>
									</dd>
								</dl>
							</div>
						</div>
						...
						<div class="links panel">
							<div class="panel-heading">
								<i class="fa fa-flask"></i>BIM
							</div>
							<div class="panel-body">
								<dl class="row">
									<dd class="col-sm-3 col-md-2 col-xs-4">
										<a
											href="javascript:if(confirm('http://www.chinarevit.com/  \n\n���ļ��޷��� Teleport Ultra ����, ��Ϊ ����һ�����·���ⲿ������Ϊ�����ʼ��ַ�ĵ�ַ��  \n\n�����ڷ������ϴ���?'))window.location='http://www.chinarevit.com/'"
											target="_blank"><i class="link-logo"></i><span
											class="link-title">中国Revit论坛</span><span class="link-info">BIM
												Revit软件交流论坛</span></a>
									</dd>
									<dd class="col-sm-3 col-md-2 col-xs-4">
										<a
											href="javascript:if(confirm('https://www.nbimer.com/materials/bim-models  \n\n���ļ��޷��� Teleport Ultra ����, ��Ϊ ����һ�����·���ⲿ������Ϊ�����ʼ��ַ�ĵ�ַ��  \n\n�����ڷ������ϴ���?'))window.location='https://www.nbimer.com/materials/bim-models'"
											target="_blank"><i class="link-logo"></i><span
											class="link-title">毕马汇BIM</span><span class="link-info">毕马汇BIM资源</span></a>
									</dd>
									<dd class="col-sm-3 col-md-2 col-xs-4">
										<a
											href="javascript:if(confirm('http://www.eabimJava/  \n\n���ļ��޷��� Teleport Ultra ����, ��Ϊ ����һ�����·���ⲿ������Ϊ�����ʼ��ַ�ĵ�ַ��  \n\n�����ڷ������ϴ���?'))window.location='http://www.eabimJava/'"
											target="_blank"><i class="link-logo"></i><span
											class="link-title">EaBIM</span><span class="link-info">BIM
												综合交流平台</span></a>
									</dd>
									<dd class="col-sm-3 col-md-2 col-xs-4">
										<a
											href="javascript:if(confirm('http://www.cnbim.com/  \n\n���ļ��޷��� Teleport Ultra ����, ��Ϊ ����һ�����·���ⲿ������Ϊ�����ʼ��ַ�ĵ�ַ��  \n\n�����ڷ������ϴ���?'))window.location='http://www.cnbim.com/'"
											target="_blank"><i class="link-logo"></i><span
											class="link-title">BIM中国网</span><span class="link-info">提供最新BIM资讯信息</span></a>
									</dd>
									<dd class="col-sm-3 col-md-2 col-xs-4">
										<a
											href="javascript:if(confirm('http://bbs.bimst.com/  \n\n���ļ��޷��� Teleport Ultra ����, ��Ϊ ����һ�����·���ⲿ������Ϊ�����ʼ��ַ�ĵ�ַ��  \n\n�����ڷ������ϴ���?'))window.location='http://bbs.bimst.com/'"
											target="_blank"><i class="link-logo"></i><span
											class="link-title">BIMst</span><span class="link-info">中国最活跃的ArchiCAD技术论坛</span></a>
									</dd>
									<dd class="col-sm-3 col-md-2 col-xs-4">
										<a
											href="javascript:if(confirm('http://bbs.zhulong.com/106010_group/  \n\n���ļ��޷��� Teleport Ultra ����, ��Ϊ ����һ�����·���ⲿ������Ϊ�����ʼ��ַ�ĵ�ַ��  \n\n�����ڷ������ϴ���?'))window.location='http://bbs.zhulong.com/106010_group/'"
											target="_blank"><i class="link-logo"></i><span
											class="link-title">筑龙BIM</span><span class="link-info">筑龙BIM社区</span></a>
									</dd>
								</dl>
							</div>
						</div>
						<hr id="tuan-dui-gong-jiu" />
						<div class="links panel">
							<div class="panel-heading">
								<i class="fa fa-bolt"></i>团队工具
							</div>
							<div class="panel-body">
								<dl class="row">
									<dd class="col-sm-3 col-md-2 col-xs-4">
										<a
											href="javascript:if(confirm('http://www.winshe.cn/index.aspx  \n\n���ļ��޷��� Teleport Ultra ����, ��Ϊ ����һ�����·���ⲿ������Ϊ�����ʼ��ַ�ĵ�ַ��  \n\n�����ڷ������ϴ���?'))window.location='http://www.winshe.cn/index.aspx'"
											target="_blank"><i class="link-logo"></i><span
											class="link-title">匀视网</span><span class="link-info">工程建设项目协作管理平台</span></a>
									</dd>
									<dd class="col-sm-3 col-md-2 col-xs-4">
										<a href="../guest-book.html" onclick="return false;"
											class="frame-link"><i class="link-logo"></i><span
											class="link-title">提交网址</span><span class="link-info"></span></a>
									</dd>
								</dl>
							</div>
						</div>
						<hr id="shi-nei-she-ji" />
						<div class="links panel">
							<div class="panel-heading">
								<i class="fa fa-bug"></i>室内设计
							</div>
							<div class="panel-body">
								<dl class="row">
									<dd class="col-sm-3 col-md-2 col-xs-4">
										<a
											href="javascript:if(confirm('http://www.rushiJava/  \n\n���ļ��޷��� Teleport Ultra ����, ��Ϊ ����һ�����·���ⲿ������Ϊ�����ʼ��ַ�ĵ�ַ��  \n\n�����ڷ������ϴ���?'))window.location='http://www.rushiJava/'"
											target="_blank"><i class="link-logo"></i><span
											class="link-title">如室网</span><span class="link-info">首发全球顶尖建筑室内作品，全球最大案例库</span></a>
									</dd>
									<dd class="col-sm-3 col-md-2 col-xs-4">
										<a href="../guest-book.html" onclick="return false;"
											class="frame-link"><i class="link-logo"></i><span
						...
						<hr id="jing-guan-she-ji" />
						<div class="links panel">
							<div class="panel-heading">
								<i class="fa fa-bug"></i>景观设计
							</div>
							<div class="panel-body">
								<dl class="row">
									<dd class="col-sm-3 col-md-2 col-xs-4">
										<a href="###" target="_blank"><i class="link-logo"></i><span
											class="link-title">大数据整理ing...</span><span class="link-info"></span></a>
									</dd>
									<dd class="col-sm-3 col-md-2 col-xs-4">
										<a href="../guest-book.html" onclick="return false;"
											class="frame-link"><i class="link-logo"></i><span
