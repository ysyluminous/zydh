        ...
        <section class="content container-fluid">
            ...
            <div class="box box-info">
                ...
                <form class="form-horizontal" >
                    <div class="box-body">
                        <div class="form-group col-sm-4 col-lg-4  col-xs-4">
                            <label for="inputEmail3" class="col-sm-4 control-label">公司</label>

                            <div class="col-sm-8">
                                <input type="text" id="groupName" class="form-control" id="inputEmail3" placeholder="公司名">
                            </div>
                        </div>
                        <div class="form-group col-sm-4 col-lg-4  col-xs-4">
                            <label for="inputPassword3" class="col-sm-4 control-label">来源</label>

                            <div class="col-sm-8">
                                <input type="text" class="form-control" id="inputPassword3" placeholder="来源">
                            </div>
                        </div>
